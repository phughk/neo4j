...
public class HughRemoteStore
{
    ...
    private final HughStoreCopyClient storeCopyClient;
    private final HughTxPullClient txPullClient;
    private final TransactionLogCatchUpFactory transactionLogFactory;

    public HughRemoteStore( LogProvider logProvider, FileSystemAbstraction fs, PageCache pageCache, HughStoreCopyClient storeCopyClient,
            HughTxPullClient txPullClient, TransactionLogCatchUpFactory transactionLogFactory, Monitors monitors )
    {
