...
import static org.neo4j.backup.nextgen.TestHelpers.executionIsExpectedToFail;
...
public class ApplicationTest
{
    ...
    @Test
    public void backupsAreRetrievedFromRemoteServerByCorrectStoreId() throws StoreIdDownloadFailedException
    {
        // given
    ...
    @Test
    public void lifecycleIsManagedEvenIfStoreIdRetrievalFails() throws StoreIdDownloadFailedException
    {
        // given
    ...
    @Test
    public void transactionsAreRetrieved() throws StoreIdDownloadFailedException
    {
        // given
        StoreId storeId = aStoreIdIsAvailableByFetch( backupDelegator, fromAddress );
    ...
    @Test
    public void failingToRetrieveTransactionsDoesNotInterfereWithLifecycle() throws StoreIdDownloadFailedException
    {
        // given
        StoreId storeId = aStoreIdIsAvailableByFetch( backupDelegator, fromAddress );
