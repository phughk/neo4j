...
public class StoreCopyService
{
    ...
    private final StoreCopyClient hughStoreCopyClient;
    private final AdvertisedSocketAddress fromAddress;

    public StoreCopyService( File storeDir, FileSystemAbstraction fileSystemAbstraction, PageCache pageCache, StoreCopyClient hughStoreCopyClient,
